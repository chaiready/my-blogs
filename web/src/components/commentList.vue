<template>
  <div class="comment-list fs-2xl">
    <div v-for="(item, index) in commentsList" :key="index" class="py-4" :class="index>0 ? 'border-top' : ''">
      <div class="d-flex">
        <div class="avatar-one text-left">
          <img :src="item.avatarImg" alt="avatar" width="50" height="50" />
        </div>
        <div class="flex-1">
          <div class="d-flex ai-center">
            <strong class="col-orange mr-4">{{item.nickName}}</strong>
            ...
            <div class v-for="(c, i) in item.children" :key="i">
              <div class="d-flex">
                <div class="mini-avatar text-left">
                  <img :src="c.avatarImg" alt="avatar" width="30" height="30" />
                </div>
                <div class="flex-1">
                  <div class="mt-0">
                    <span>
                      <strong class="col-orange mr-4">{{c.nickName}}</strong>
                    </span>
                    <span class="col-grey-4">
                      <span class="fs-xl">{{item.createdAt | formatDate}}</span>
                      <strong
                  ...
                  <div class="py-2">
                    ...
                    <span>
                      <span class="col-purple-light">@{{c.byAiteName}}：</span>
                      {{c.content}}
                    </span>
                  </div>
                </div>
