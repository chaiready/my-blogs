<template>
  <div class="fs-3xl py-5 px-4">
    ...
    <p class="mb-2"><strong class="fs-9xl">曼巴 </strong>89年老腊肉！毕业于湖北工程学院的物理与电子信息专业，</p>
    <p class="mb-2">毕业后去当兵，退伍回来后，四肢发达，头脑简单，大学所修内功心法尽失，</p>
    <p class="mb-2">江湖传闻有一神功：Web前端，不需自宫，也能成功，遂改行……，一入前端深似海</p>
    <p class="mb-2">一个人静静坐在电脑面前写代码的感觉，那是什么感觉？那是武林高手闭关修炼的感觉。</p>
    <p class="m-0">相信编程是一门武术，喜欢用代码来表达心灵鸡汤。</p>
    <img src="../assets/lizi.jpg" alt="lizi" height="200">
    </div>
    ...
    <div class="text-center biaoqing">
      <p class="my-4">纳尼？</p>
      <img src="../assets/nani.jpg" alt="lizi" height="200">  
      <p class="my-4">我也不知道想表达什么，我先干了这碗鸡汤啊，你们随意！</p>
      <img src="../assets/jitang.jpg" alt="lizi" height="200">
...
export default {
  ...
  methods: {
    async getCodeHtml() {
      let res = await this.$axios.get("/blogs/5e5c9cec17a998034f0a6d15");
